/**
 * VIBENICITY Claude API Generator
 * 
...
const ClaudeAPIGenerator = {
    ...
    /**
     * Normalize message using VIBENICITY's cultural vocabulary
     */
...
RESPOND WITH ONLY VALID JSON (no markdown):
{
  ...
  "auth": true
    ...
    async callGeminiForSchema(prompt) {
        ...
        const apiKey = window.VibenicityCodeGenerator?.config?.apiKey || 
    ...
    genPackageJson(schema) {
        const pkg = {
            name: this.toKebabCase(schema.apiName || 'vibenicity-api'),
            version: '1.0.0',
            description: schema.description || 'Generated by VIBENICITY',
            main: 'src/index.js',
            scripts: {
 ...
 * Generated by VIBENICITY API Generator
 */
...
app.get('/health', (req, res) => {
    res.json({ 
        status: 'ok', 
        api: '${schema.apiName || 'VIBENICITY API'}',
...
`;
    ...
    genPrismaSchema(schema) {
        let prisma = `// Generated by VIBENICITY API Generator
...
const JWT_SECRET = process.env.JWT_SECRET || 'vibenicity-secret-change-me';
...
${schema.description || 'API generated by VIBENICITY'}
...
`;
    ...
    generateDeployConfig(schema) {
        return {
            railway: {
                name: schema.apiName || 'vibenicity-api',
