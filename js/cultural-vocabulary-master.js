...
window.searchVocabulary = window.culturalVocabularyMaster.searchVocabulary.bind(window.culturalVocabularyMaster);
window.filterByCategory = window.culturalVocabularyMaster.filterByCategory.bind(window.culturalVocabularyMaster);
window.getRandomTerm = window.culturalVocabularyMaster.getRandomTerm.bind(window.culturalVocabularyMaster);
window.translateSlang = window.culturalVocabularyMaster.translate.bind(window.culturalVocabularyMaster);

console.log('✅ Cultural Vocabulary Master Database Loaded');
console.log('📊 Stats:', window.culturalVocabularyMaster.getStats());
