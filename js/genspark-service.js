...
class GenSparkService {
    ...
    parseCodeBlocks(content, options = {}) {
        ...
        return {
            projectName: options.projectName || 'vibelyf-app',
            description: 'Generated by VibeLyf with GenSpark',
            files: files,
     ...
     */
    getSystemPrompt() {
        return `You are an expert full-stack web developer integrated into VibeLyf, a platform that makes code creation accessible through cultural language understanding.
